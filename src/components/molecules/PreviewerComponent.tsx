...
const PreviewerComponent: React.FC<PreviewerComponentProps> = ({ children, name, className}) => {
    return (
       <>
          ...
          <div className={classNames('w-full', '!h-auto', 'rounded-2xl', 'backdrop-blur', 'dark:bling-bg-dots-dark-bg-1','bling-bg-dots-light', 'border', 'bling-light-border', 'dark:bling-dark-border', 'p-6', className)}>
            {children}
          </div>
          </div>
          </>
