...
import { ChatLine, Eye, Pen2, TrashBin2 } from '@/icons/tsx';
import Image from 'next/image';
import { Pagination } from '@/components/molecules';


interface ITableInReviewShippingProps {}

const TableInReviewShipping: React.FC<ITableInReviewShippingProps> = ({}) => {
            ...
            data: [
              ...
              <div className="flex justify-center items-center">
                <Chip status="info" text="$50.00" className="font-JetBrainsMono  self-center" />
                  ...
                  <Dropdown position='bottom-left'  trigger={ <Chip status="attention" text="En Revisión" className="font-JetBrainsMono self-center hover:scale-105  transition-all ease-in-out duration-150" />}>
