...
import { ChatLine, Eye, Times} from '@/icons/tsx';
import Image from 'next/image';
import { Pagination } from '@/components/molecules';


interface ITableInProgressShippingProps {}

const TableInProgressShipping: React.FC<ITableInProgressShippingProps> = ({}) => {
  ...
  const handleDelete = async(productDisplayId: number) => {
    try {
      ...
      toasts.error('Error al intentar eliminar el producto', 4000);
    }
  };
...
export { TableInProgressShipping };