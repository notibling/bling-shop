...
import { BaseTable, UserButton, useToasts } from '@/components/organisms';
import { Eye } from '@/icons/tsx';
import Image from 'next/image';
import { UserProfile } from '@/components/molecules';

interface ITableCancelledShippingProps {}

const TableCancelledShipping: React.FC<ITableCancelledShippingProps> = ({}) => {
