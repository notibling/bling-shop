...
interface ITableAllShippingProps {}

const TableAllShipping: React.FC<ITableAllShippingProps> = ({}) => {
        ...
        rows={[
          {
            data: [
              ...
              <div className='flex justify-center items-center'>
                <Chip status='success' text='Activo' className='font-JetBrainsMono self-center' />
              </div>,
              <div className='flex justify-center items-center'>
