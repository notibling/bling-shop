...
interface ITableAllPurchasedProps {}

const TableAllPurchased: React.FC<ITableAllPurchasedProps> = ({}) => {
  return (
    <Fragment>
      <BaseTable
        rowHeaderClassName='text-center'
       
        headers={[<Checkbox key='checkbox-header' onChange={() => {}} />, 'Portada', 'N° Factura', 'Producto', 'Fecha de Compra', 'Cantidad', 'Precio', 'Estado', 'Ver']}
        rows={[
          {
            data: [
          ...
          },
          {
            data: [
              ...
              <div className='flex justify-center items-center'>
                <Chip status='warning' text='Cuota 1/6' className='font-JetBrainsMono self-center' />
              </div>,
              <div className='flex justify-center items-center'>
                <Button icon={<Icon name={Eye} size={20} />} className='h-10 w-10 rounded-md  dark:bling-btn-primary-dark bling-btn-primary border  dark:border-bling-dark-bg-5 border-bling-light-bg-4' />
              </div>
          ...
          },
          {
            data: [
              ...
              <div className='flex justify-center items-center'>
                <Chip status='error' text='Devuelto' className='font-JetBrainsMono self-center' />
              </div>,
              <div className='flex justify-center items-center'>
                <Button icon={<Icon name={Eye} size={20} />} className='h-10 w-10 rounded-md  dark:bling-btn-primary-dark bling-btn-primary border  dark:border-bling-dark-bg-5 border-bling-light-bg-4' />
              </div>
          ...
          },
          {
            data: [
              ...
              <div className='flex justify-center items-center'>
                <Chip status='error' text='Cancelado' className='font-JetBrainsMono self-center' />
              </div>,
              <div className='flex justify-center items-center'>
                <Button icon={<Icon name={Eye} size={20} />} className='h-10 w-10 rounded-md  dark:bling-btn-primary-dark bling-btn-primary border  dark:border-bling-dark-bg-5 border-bling-light-bg-4' />
              </div>
