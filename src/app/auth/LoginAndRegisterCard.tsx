...
export const LoginAndRegisterCard: React.FC<ILoginAndRegisterCardProps> = ({ title, children, className }) => {
  return (
    <div className={classNames(className, 'w-full', 'bling-light', 'dark:bling-dark-bg-2', 'rounded-brand', 'flex', 'justify-center', 'items-center', 'h-full', 'flex-col', 'rounded-md', 'overflow-hidden')}>
