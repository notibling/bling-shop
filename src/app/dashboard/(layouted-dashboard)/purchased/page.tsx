...
import { AlignVerticalSpacing, AltArrowDown, Cart3, ChatLine, Check, Csv, DownloadMinimalistic, History2, ListDownMinimalistic, Pdf, Printer2, SortHorizontal, Star, Times, TrashBin2, Xls } from '@/icons/tsx';
import { Dropdown, DropdownItem, TitleSection } from '@/components/organisms';
import { TableAllPurchased } from '@/components/Views/Dashboard/Purchased';
...
const Purchased: React.FC<PurchasedProps> = () => {
    return (
      ...
      <TitleSection icon={Cart3}
                      iconSize={30}
                      title="Todas mis compras" 
                      description="Resumen general de compras"
                      level="h5"
      ...
      <div className="w-full  gap-2  grid grid-cols-2 lg:grid-cols-3 bling-light dark:bling-dark-bg-1 border bling-light-border dark:bling-dark-border p-2  rounded-md">
        <div className="col-span-2 lg:col-span-1  order-1 lg:order-1 flex flex-row gap-2 justify-start items-center z-[999] ">
        ...
        <div className="col-span-2 lg:col-span-1 order-2 lg:order-3 flex flex-row gap-2  justify-end items-center">
