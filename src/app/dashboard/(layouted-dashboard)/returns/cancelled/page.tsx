...
import { AlignVerticalSpacing, Check, Csv, DownloadMinimalistic, ListDownMinimalistic, Pdf,  Printer2, Times, TrashBin2, Xls } from '@/icons/tsx';
import { Dropdown, DropdownItem, TitleSection } from '@/components/organisms';
import { TableCancelledReturns } from '@/components/Views/Dashboard/Returns';



interface CancelledReturnsProps {}

const CancelledReturns: React.FC<CancelledReturnsProps> = ({}) => {
  return (
    <>
      ...
      <TitleSection icon={Times}
                      ...
                      title={
                        <>
                         <div className="w-auto h-auto flex-row justify-start items-center flex gap-1"><span>Devoluciones</span><span className='bling-status bling-status-error dark:bling-status-error-dark font-JetBrainsMono leading-normal h-6 items-center justify-center '>Cancelados</span></div> 
                        </>
                      } 
                      description="Estas Devoluciones no llegarán a destino"
                      level="h5"
...
export  default CancelledReturns  ;