...
import { TableInReviewSales } from '@/components/Views/Dashboard/Sales';



interface InReviewSalesProps {}

const InReviewSales: React.FC<InReviewSalesProps> = ({}) => {
  return (
    <>
...
<TitleSection icon={EyeScan} iconSize={30}  level="h5" title={
    <>
      <div className="w-auto h-auto flex-row justify-start items-center flex gap-1"><span>Ventas</span><span className='bling-status font-JetBrainsMono leading-normal  bling-status-attention dark:bling-status-attention-dark h-6 items-center justify-center '>En Revisión</span></div> 
    </>
