...
import { AlignVerticalSpacing, AltArrowDown, BillCheck, Check, Csv, DownloadMinimalistic, EyeScan, ListDownMinimalistic, Pause, Pdf, Pen2, Play, Printer2, TrashBin2, Widget2, Xls } from '@/icons/tsx';
  ...
  return (
    <main className={classNames('w-full')}>
      <Section Empty={true} className='flex-col  items-start justify-start h-fit !p-0 m-0 flex gap-4 !bg-transparent rounded-md'>
        ...
        <TitleSection icon={BillCheck}
          iconSize={30}
          title='Todas las Ventas'
          description='Conocé el resumen general de tus ventas'
          level='h5'
