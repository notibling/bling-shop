...
import { AlignVerticalSpacing, ChatLine, Check, Csv, DownloadMinimalistic, EyeScan, History2, ListDownMinimalistic, Pdf, Pen2, Printer2, Times, TrashBin2, Xls } from '@/icons/tsx';
...
interface InProgressSalesProps {}

const InProgressSales: React.FC<InProgressSalesProps> = ({}) => {
  return (
    <>
...
<TitleSection icon={History2} iconSize={30}  level="h5" title={
    <>
      <div className="w-auto h-auto flex-row justify-start items-center flex gap-1"><span>Ventas</span><span className='bling-status font-JetBrainsMono leading-normal  bling-status-warning dark:bling-status-warning-dark h-6 items-center justify-center '>En Progreso</span></div> 
    </>
  }  description="Ventas con observaciones pendientes"
...
export  default InProgressSales ;
