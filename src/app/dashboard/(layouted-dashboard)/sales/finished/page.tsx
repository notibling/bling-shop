...
import { AlignVerticalSpacing, CashOut, ChatLine, Check, Csv, DownloadMinimalistic, ListDownMinimalistic, Pdf, Pen2, Printer2, TrashBin2, Xls } from '@/icons/tsx';
import { Dropdown, DropdownItem, TitleSection } from '@/components/organisms';
import { TableFinishedSales } from '@/components/Views/Dashboard/Sales';
import IconPattern from '@/components/molecules/IconPattern';


interface FinishedSalesProps {}

const FinishedSales: React.FC<FinishedSalesProps> = ({}) => {
  return (
    <>
      ...
      <TitleSection icon={Check}
                      ...
                      description="Ventas completadas con éxito"
                      level="h5"
