...
import { AlignVerticalSpacing, AltArrowDown, Check, Csv, Delivery, DownloadMinimalistic, EyeScan, ListDownMinimalistic, Pause, Pdf, Pen2, Play, Printer2, TrashBin2, Widget2, Xls } from '@/icons/tsx';
