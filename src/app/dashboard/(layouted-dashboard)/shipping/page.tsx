...
import { AlignVerticalSpacing, AltArrowDown, BillCheck, Check, Csv, Delivery, DownloadMinimalistic, EyeScan, ListDownMinimalistic, Pause, Pdf, Pen2, Play, Printer2, TrashBin2, Widget2, Xls } from '@/icons/tsx';
...
const Shipping: React.FC<ShippingProps> = () => {
 ...
 <TitleSection icon={Delivery}
                      iconSize={30}
                      title="Resumen de envíos"
                      description="Resumen detallado de tus envíos"
                      level="h5"
