...
interface InProgressShippingProps {}

const InProgressShipping: React.FC<InProgressShippingProps> = ({}) => {
  return (
    <>
...
<TitleSection icon={History2} iconSize={30}  level="h5" title={
    <>
      <div className="w-auto h-auto flex-row justify-start items-center flex gap-1"><span>Envíos</span><span className='bling-status font-JetBrainsMono leading-normal  bling-status-warning dark:bling-status-warning-dark h-6 items-center justify-center '>En Progreso</span></div> 
    </>
  }  description="Envíos en camino"
...
export  default InProgressShipping ;
