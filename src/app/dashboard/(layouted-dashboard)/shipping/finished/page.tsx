...
import { AlignVerticalSpacing, ChatLine, Check, Csv, DownloadMinimalistic, ListDownMinimalistic, Pdf, Printer2, Star, TrashBin2, Xls } from '@/icons/tsx';
import { Dropdown, DropdownItem, TitleSection } from '@/components/organisms';
import { TableFinishedShipping } from '@/components/Views/Dashboard/Shipping';


interface FinishedShippingProps {}

const FinishedShipping: React.FC<FinishedShippingProps> = ({}) => {
  return (
    <>
...
export default FinishedShipping;
