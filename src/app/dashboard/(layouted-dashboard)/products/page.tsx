...
import { Button, Icon, Item, Section, Title, Separator } from '@/components/atoms';
import { Pagination, SearchBar } from '@/components/molecules';
import { AlignVerticalSpacing, AltArrowDown, Check, Csv, DownloadMinimalistic, EyeScan, ListDownMinimalistic, Pause, Pdf, Pen2, Play, Printer2, TrashBin2, Widget2, Xls } from '@/icons/tsx';
import { Dropdown, DropdownItem, TitleSection } from '@/components/organisms';
import { TableAllProducts } from '@/components/Views/Dashboard/Products';
...
const Products: React.FC<ProductsProps> = () => {
 ...
 <TitleSection icon={Widget2}
                      iconSize={30}
                      title="Todos los Productos" 
                      description="Ajuste general de productos"
                      level="h5"
                      pattern={'dhb-pat-products'} />
     
      
        <div className="w-full  gap-2  grid grid-cols-2 lg:grid-cols-3 bling-light dark:bling-dark-bg-1 border bling-light-border dark:bling-dark-border   bling-light p-2  rounded-md">
        ...
        <div className="relative flex flex-col   w-full h-full bling-light dark:bling-dark-bg-1 border bling-light-border dark:bling-dark-border  bling-light rounded-md ">
          <div className=" p-2">
            <TableAllProducts />
