...
const SvgSsdRound = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={props.width || 24} height={props.height || 24} fill="currentColor" viewBox="0 0 24 24" {...props}>
    <path d="M5.5 13.588h13c1.311 0 2.454.764 3.053 1.893L19 5.118C18.5 3.529 17.605 3 16.5 3h-9c-1.105 0-2 .53-2.5 2.118L2.447 15.48c.6-1.13 1.742-1.893 3.053-1.893" opacity={0.5} />
    <path
      fillRule="evenodd"
