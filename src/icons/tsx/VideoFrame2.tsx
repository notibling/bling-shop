...
const SvgVideoFrame2 = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width || 24} height={props.height || 24} fill='currentColor' viewBox='0 0 24 24' {...props}>
    <path d='M11.25 2.031A1 1 0 0 0 11 2H7.75v4.25h3.5zM11.25 7.75H2V14q-.001.677.004 1.25h9.246zM11.25 16.75h-3.5V20l.917.001h2.583zM6.25 2.023c-1.61.055-2.588.239-3.274.856-.75.675-.924 1.666-.964 3.371H6.25zM6.25 16.75v3.227c-1.61-.055-2.588-.239-3.274-.856-.59-.53-.823-1.256-.915-2.37z' />
    <g opacity={0.5}>
