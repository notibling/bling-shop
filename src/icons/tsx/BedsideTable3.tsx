...
const SvgBedsideTable3 = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width || 24} height={props.height || 24} fill='currentColor' viewBox='0 0 24 24' {...props}>
    <path
      ...
      clipRule='evenodd'
    />
    <path d='M3.172 3.172C2 4.343 2 6.229 2 10v1h20v-1c0-3.771 0-5.657-1.172-6.828S17.771 2 14 2h-4C6.229 2 4.343 2 3.172 3.172' opacity={0.5} />
    <path d='M9 5.75a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 0-1.5z' />
  </svg>
);
