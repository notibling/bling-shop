...
const SvgChatRoundVideo = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width || 24} height={props.height || 24} fill='currentColor' viewBox='0 0 24 24' {...props}>
    ...
    <path d='M13.22 9.447C15.073 10.586 16 11.156 16 12c0 .845-.927 1.414-2.78 2.553-1.88 1.155-2.819 1.732-3.52 1.308C9 15.437 9 14.291 9 12s0-3.437.7-3.861c.701-.424 1.64.153 3.52 1.308' />
  </svg>
);
