...
const SvgWalkingRound = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={props.width || 24} height={props.height || 24} fill="currentColor" viewBox="0 0 24 24" {...props}>
    <path
      ...
      clipRule="evenodd"
    />
    <path d="M15 4.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0M10.147 16.765a.75.75 0 0 1 .588.882 7.75 7.75 0 0 1-2.757 4.532l-.51.407a.75.75 0 1 1-.936-1.171l.509-.408a6.25 6.25 0 0 0 2.224-3.654.75.75 0 0 1 .882-.588" opacity={0.5} />
  </svg>
);
