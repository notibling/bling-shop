...
const SvgRemoteControllerMinimalistic = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={props.width || 24} height={props.height || 24} fill="currentColor" viewBox="0 0 24 24" {...props}>
    <path
      ...
      opacity={0.5}
    />
    <path d="M13 5a1 1 0 1 1-2 0 1 1 0 0 1 2 0M12 18a1 1 0 1 0 0-2 1 1 0 0 0 0 2" />
    <path fillRule="evenodd" d="M8.25 11a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0m1.5 0a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0" clipRule="evenodd" />
  </svg>
);
