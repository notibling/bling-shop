...
const SvgLibrary = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width || 24} height={props.height || 24} fill='currentColor' viewBox='0 0 24 24' {...props}>
    <path
      ...
      clipRule='evenodd'
    />
    <path d='M8.51 2h6.98c.233 0 .41 0 .567.015 1.108.109 2.014.775 2.399 1.672H5.544c.385-.897 1.292-1.563 2.4-1.672C8.099 2 8.278 2 8.51 2' opacity={0.4} />
    <path d='M6.31 4.723c-1.39 0-2.53.84-2.91 1.953l-.024.07c.399-.12.813-.199 1.232-.253 1.08-.138 2.446-.138 4.032-.138h6.892c1.586 0 2.952 0 4.032.138.42.054.834.133 1.232.253l-.023-.07c-.38-1.114-1.52-1.953-2.911-1.953z' opacity={0.7} />
  </svg>
);
