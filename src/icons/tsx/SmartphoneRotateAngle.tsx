...
const SvgSmartphoneRotateAngle = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={props.width || 24} height={props.height || 24} fill="currentColor" viewBox="0 0 24 24" {...props}>
    <path
      ...
      clipRule="evenodd"
    />
    <path d="M19 9v10s-4.157 2-7 2-7-2-7-2V9c0-2.809 0-4.213.674-5.222a4 4 0 0 1 1.104-1.104C7.787 2 9.19 2 12 2s4.213 0 5.222.674c.437.292.812.667 1.104 1.104C19 4.787 19 6.19 19 9" opacity={0.5} />
    <path d="M9 4.25a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 0-1.5z" />
  </svg>
);
