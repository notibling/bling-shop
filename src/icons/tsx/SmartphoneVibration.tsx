...
const SvgSmartphoneVibration = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width || 24} height={props.height || 24} fill='currentColor' viewBox='0 0 24 24' {...props}>
    <path d='M5.879 2.879C5 3.757 5 5.172 5 8v8c0 2.828 0 4.243.879 5.121S8.172 22 11 22h2c2.829 0 4.243 0 5.122-.879C19 20.243 19 18.828 19 16V8c0-2.828 0-4.243-.878-5.121C17.242 2 15.829 2 13 2h-2c-2.828 0-4.242 0-5.121.879' opacity={0.5} />
    <path d='M9.5 18.25a.75.75 0 0 0 0 1.5h5a.75.75 0 0 0 0-1.5z' />
    <path
      fillRule='evenodd'
