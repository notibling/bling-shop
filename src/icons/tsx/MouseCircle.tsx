...
const SvgMouseCircle = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={props.width || 24} height={props.height || 24} fill='currentColor' viewBox='0 0 24 24' {...props}>
    <path
      ...
      opacity={0.5}
    />
    <path d='M7.907 13.954c0 2.29 1.833 4.148 4.093 4.148s4.093-1.857 4.093-4.148v-3.37H7.907zM12.768 9.338h3.253c-.312-1.667-1.608-3.292-3.253-3.609zM11.233 9.338V5.73c-1.645.317-2.942 1.942-3.254 3.61z' />
  </svg>
);
